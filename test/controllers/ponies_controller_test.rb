...
class PoniesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pony" do
    assert_difference('Pony.count') do
      post ponies_url, params: { pony: { age: @pony.age, breed: @pony.breed, color: @pony.color, height: @pony.height } }
    end
  ...
  test "should update pony" do
    patch pony_url(@pony), params: { pony: { age: @pony.age, breed: @pony.breed, color: @pony.color, height: @pony.height } }
